import { Box, Wrap, WrapItem, Container, Button } from '@chakra-ui/react'
...
const CurrentFavs = () => {
    ...
    return (
        ...
        <Wrap p="4" background="blackAlpha.50" boxShadow="inset 0px 2px 4px rgba(0, 0, 0, 0.06)" w={{ base: "90vw", md: "80vw", lg: "66vw" }} border="2px" borderRadius="2xl" borderColor="blackAlpha.100">
            <WrapItem >
                <Image
